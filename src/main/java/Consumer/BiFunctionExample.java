...
public class BiFunctionExample {
    ...
    static BiFunction<List<Person>,Predicate<Person>, Map<String,Double>> vf2=(listOfPersons,predicate)
    ->{
    ...
    public static void main(String[] args) {
        System.out.println("Result1: "+bf1.apply("java","features"));
        List<Person>personList= PersonRepository.getAllPersons();
        Map<String,Double>map= vf2.apply(personList,p2);
